...
public class Ex0_main {
    public static Long ID0=209328970L, ID1 = 324496736L, ID2 = null;
...
//        ElevatorAlgo ex0_alg = new ShabatElev3Algo(Simulator_A.getBuilding());    // Shabat Elev with two trick - replace with your code;
        ElevatorAlgoC ex0_alg = new ElevatorAlgoC(Simulator_A.getBuilding());    // Shabat Elev with two trick - replace with your code;
